...
plt.figure(1)
plt.plot(n, err1_oNC, label="oNC-1")
plt.plot(n, err1_cNC, label="cNC-1")
plt.plot(n, err1_GL, label="GL-1")
plt.legend()
plt.grid()
plt.title("Error Estimate for 1. Function")

plt.figure(2)
plt.plot(n, err2_oNC, label = "oNC-2")
plt.plot(n, err2_cNC, label="cNC-2")
plt.plot(n, err2_GL, label="GL-2")
plt.legend()
plt.grid()
plt.title("Error Estimate for 2. Function")

plt.figure(3)
plt.plot(n, err3_oNC, label="oNC-3")
plt.plot(n, err3_cNC, label="cNC-3")
plt.plot(n, err3_GL, label="GL-3")
plt.legend()
plt.grid()
